      ...
      lists: [
        ...
        },
        {
          ...
          stats: {
            ...
            cleaned_count: 28,
            member_count_since_send: 60,
            unsubscribe_count_since_send: 4,
            cleaned_count_since_send: 8,
            campaign_count: 18,
            campaign_last_sent: "2022-01-27T18:00:24+00:00",
            merge_field_count: 4,
            avg_sub_rate: 29,
            avg_unsub_rate: 1,
            target_sub_rate: 4,
            ...
            last_sub_date: "2022-01-26T17:34:27+00:00",
        ...
        },
        {
          ...
          stats: {
            ...
            open_rate: 0,
            click_rate: 0,
            last_sub_date: "2022-01-28T00:58:45+00:00",
...
nock("https://us3.api.mailchimp.com:443", { encodedQueryParams: true })
  ...
  .reply(
      ...
      members: [
        {
          ...
          timestamp_opt: "2022-01-28T00:58:45+00:00",
          member_rating: 2,
          last_changed: "2022-01-28T00:58:45+00:00",
          language: "",
          vip: false,
          email_client: "",
          location: {
        ...
        },
        {
          ...
          timestamp_signup: "",
          ip_opt: "71.231.106.197",
          timestamp_opt: "2022-01-28T00:58:44+00:00",
          member_rating: 2,
          last_changed: "2022-01-28T00:58:44+00:00",
          language: "",
          vip: false,
          email_client: "",
          location: {
    ...
    [
      ...
      "Accept-Encoding",
      "X-Request-Id",
      "58b1a70f-bed9-b059-10aa-0d81299f9c24",
      "Link",
...
nock("https://us3.api.mailchimp.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "Accept-Encoding",
      "X-Request-Id",
      "4d2a5e02-8058-5b2f-d1b1-79eaffd1bd84",
      "Link",
      '<https://us3.api.mailchimp.com/schema/3.0/Lists/MergeFields/Collection.json>; rel="describedBy"',
      "Date",
      "Fri, 28 Jan 2022 01:01:23 GMT",
      "Content-Length",
      "8805",
      "Connection",
      "close",
...
nock("https://us3.api.mailchimp.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "Accept-Encoding",
      "X-Request-Id",
      "d848c358-fbf4-6d28-d707-dc02c4cd4552",
      "Link",
      '<https://us3.api.mailchimp.com/schema/3.0/Lists/Members/Collection.json>; rel="describedBy"',
      "Date",
      "Fri, 28 Jan 2022 01:01:23 GMT",
...
nock("https://us3.api.mailchimp.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "Accept-Encoding",
      "X-Request-Id",
      "832d9e0f-d1e4-1da3-982f-32486cedea53",
      "Link",
      '<https://us3.api.mailchimp.com/schema/3.0/Lists/MergeFields/Collection.json>; rel="describedBy"',
      "Date",
      "Fri, 28 Jan 2022 01:01:23 GMT",
...
nock("https://us3.api.mailchimp.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "Accept-Encoding",
      "X-Request-Id",
      "928a65fd-0dd0-cf1d-bce0-92a2080354e5",
      "Link",
      '<https://us3.api.mailchimp.com/schema/3.0/Lists/Members/Collection.json>; rel="describedBy"',
      "Date",
      "Fri, 28 Jan 2022 01:01:24 GMT",
      "Content-Length",
      "33884",
      "Connection",
      "close",
...
nock("https://us3.api.mailchimp.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "Accept-Encoding",
      "X-Request-Id",
      "4b964863-cc11-2aa5-26ac-f2a6ed854cb4",
      "Link",
      '<https://us3.api.mailchimp.com/schema/3.0/Lists/Members/Collection.json>; rel="describedBy"',
      "Date",
      "Fri, 28 Jan 2022 01:01:24 GMT",
...
nock("https://us3.api.mailchimp.com:443", { encodedQueryParams: true })
  ...
  .query({
    ...
    count: "100",
    offset: "0",
    since_last_changed: "2022-01-28T00%3A58%3A44.999Z",
  })
  .once()
  .reply(
    200,
    ...
    [
      ...
      "Accept-Encoding",
      "X-Request-Id",
      "999d4359-f51a-17f5-581b-5c48883a2b00",
      "Link",
      '<https://us3.api.mailchimp.com/schema/3.0/Lists/Members/Collection.json>; rel="describedBy"',
      "Date",
      "Fri, 28 Jan 2022 01:01:25 GMT",
      "Content-Length",
      "17372",
      "Connection",
      "close",
...
nock("https://us3.api.mailchimp.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "Accept-Encoding",
      "X-Request-Id",
      "d71a59c8-60b0-3af9-ecda-f7cd57015eee",
      "Link",
      '<https://us3.api.mailchimp.com/schema/3.0/Lists/Members/Collection.json>; rel="describedBy"',
      "Date",
      "Fri, 28 Jan 2022 01:01:26 GMT",
      "Connection",
      "close",
    ]
  );
nock("https://us3.api.mailchimp.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "Accept-Encoding",
      "X-Request-Id",
      "126bc910-a5dc-510a-89cb-68cbd5daea95",
      "Link",
      '<https://us3.api.mailchimp.com/schema/3.0/Lists/Members/Collection.json>; rel="describedBy"',
      "Date",
      "Fri, 28 Jan 2022 01:01:27 GMT",
      "Content-Length",
      "17372",
      "Connection",
      "close",
...
nock("https://us3.api.mailchimp.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "Accept-Encoding",
      "X-Request-Id",
      "645e9447-931d-e173-48d1-3d5ab1a00e88",
      "Link",
      '<https://us3.api.mailchimp.com/schema/3.0/Lists/Members/Collection.json>; rel="describedBy"',
      "Date",
      "Fri, 28 Jan 2022 01:01:27 GMT",
...
nock("https://us3.api.mailchimp.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "Accept-Encoding",
      "X-Request-Id",
      "de0b8898-e83f-de7f-2b18-fb91ba39edc1",
      "Link",
      '<https://us3.api.mailchimp.com/schema/3.0/Lists/Members/Collection.json>; rel="describedBy"',
      "Date",
      "Fri, 28 Jan 2022 01:01:27 GMT",

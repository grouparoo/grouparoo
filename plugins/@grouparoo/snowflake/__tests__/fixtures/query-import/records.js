  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 10,
        returned: 10,
        queryId: "01a0144c-0601-4f7d-0029-f783001c2492",
  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 0,
        returned: 0,
        queryId: "01a0144c-0601-4f8a-0029-f783001c34de",
        databaseProvider: null,
        finalDatabaseName: "SAMPLE_SOURCES",
        finalSchemaName: "PUBLIC",
        finalWarehouseName: "COMPUTE_WH",
  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 4,
        returned: 4,
        queryId: "01a0144c-0601-4f7d-0029-f783001c24a6",
        databaseProvider: null,
        finalDatabaseName: "SAMPLE_SOURCES",
        finalSchemaName: "PUBLIC",
        finalWarehouseName: "COMPUTE_WH",
  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 4,
        returned: 4,
        queryId: "01a0144c-0601-4f8a-0029-f783001c34e6",
        databaseProvider: null,
        finalDatabaseName: "SAMPLE_SOURCES",
        finalSchemaName: "PUBLIC",
        finalWarehouseName: "COMPUTE_WH",
  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 2,
        returned: 2,
        queryId: "01a0144c-0601-4f7d-0029-f783001c24b2",
        databaseProvider: null,
        finalDatabaseName: "SAMPLE_SOURCES",
        finalSchemaName: "PUBLIC",
        finalWarehouseName: "COMPUTE_WH",

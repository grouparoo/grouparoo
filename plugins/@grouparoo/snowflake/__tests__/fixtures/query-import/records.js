  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 10,
        returned: 10,
        queryId: "019f593b-0401-2c3c-0029-f783001b38d2",
  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 0,
        returned: 0,
        queryId: "019f593b-0401-2cb4-0029-f783001b2896",
        databaseProvider: null,
        finalDatabaseName: "SAMPLE_SOURCES",
        finalSchemaName: "PUBLIC",
        finalWarehouseName: "COMPUTE_WH",
  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 4,
        returned: 4,
        queryId: "019f593b-0401-2c3c-0029-f783001b38e6",
        databaseProvider: null,
        finalDatabaseName: "SAMPLE_SOURCES",
        finalSchemaName: "PUBLIC",
        finalWarehouseName: "COMPUTE_WH",
  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 4,
        returned: 4,
        queryId: "019f593b-0401-2c3c-0029-f783001b38f2",
        databaseProvider: null,
        finalDatabaseName: "SAMPLE_SOURCES",
        finalSchemaName: "PUBLIC",
        finalWarehouseName: "COMPUTE_WH",
  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 2,
        returned: 2,
        queryId: "019f593b-0401-2c3c-0029-f783001b38fa",
        databaseProvider: null,
        finalDatabaseName: "SAMPLE_SOURCES",
        finalSchemaName: "PUBLIC",
        finalWarehouseName: "COMPUTE_WH",

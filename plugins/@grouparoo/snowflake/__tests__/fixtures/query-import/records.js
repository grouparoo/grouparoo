  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 10,
        returned: 10,
        queryId: "01a02413-0601-4f7d-0029-f783001c2b3a",
  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 0,
        returned: 0,
        queryId: "01a02413-0601-4f8a-0029-f783001c3ba6",
        databaseProvider: null,
        finalDatabaseName: "SAMPLE_SOURCES",
        finalSchemaName: "PUBLIC",
        finalWarehouseName: "COMPUTE_WH",
  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 4,
        returned: 4,
        queryId: "01a02413-0601-4f8a-0029-f783001c3baa",
        databaseProvider: null,
        finalDatabaseName: "SAMPLE_SOURCES",
        finalSchemaName: "PUBLIC",
        finalWarehouseName: "COMPUTE_WH",
  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 4,
        returned: 4,
        queryId: "01a02414-0601-4f7d-0029-f783001c2b42",
        databaseProvider: null,
        finalDatabaseName: "SAMPLE_SOURCES",
        finalSchemaName: "PUBLIC",
        finalWarehouseName: "COMPUTE_WH",
  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 2,
        returned: 2,
        queryId: "01a02414-0601-4f8a-0029-f783001c3bb2",
        databaseProvider: null,
        finalDatabaseName: "SAMPLE_SOURCES",
        finalSchemaName: "PUBLIC",
        finalWarehouseName: "COMPUTE_WH",

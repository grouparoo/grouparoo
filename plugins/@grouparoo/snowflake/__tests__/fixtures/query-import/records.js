  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 10,
        returned: 10,
        queryId: "01a11fcd-0601-82ce-0029-f783001de35e",
  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 0,
        returned: 0,
        queryId: "01a11fcd-0601-8417-0029-f783001dd706",
        databaseProvider: null,
        finalDatabaseName: "SAMPLE_SOURCES",
        finalSchemaName: "PUBLIC",
        finalWarehouseName: "COMPUTE_WH",
  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 4,
        returned: 4,
        queryId: "01a11fcd-0601-82ce-0029-f783001de36a",
        databaseProvider: null,
        finalDatabaseName: "SAMPLE_SOURCES",
        finalSchemaName: "PUBLIC",
        finalWarehouseName: "COMPUTE_WH",
  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 4,
        returned: 4,
        queryId: "01a11fcd-0601-82ce-0029-f783001de372",
        databaseProvider: null,
        finalDatabaseName: "SAMPLE_SOURCES",
        finalSchemaName: "PUBLIC",
        finalWarehouseName: "COMPUTE_WH",
  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 2,
        returned: 2,
        queryId: "01a11fcd-0601-82ce-0029-f783001de376",
        databaseProvider: null,
        finalDatabaseName: "SAMPLE_SOURCES",
        finalSchemaName: "PUBLIC",
        finalWarehouseName: "COMPUTE_WH",

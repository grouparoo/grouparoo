  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 6,
        returned: 6,
        queryId: "019eaace-0401-0eae-0029-f783001980d6",
  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 10,
        returned: 10,
        queryId: "019eaace-0401-0eae-0029-f783001980de",
        databaseProvider: null,
        finalDatabaseName: "SAMPLE_SOURCES",
        finalSchemaName: "PUBLIC",
        finalWarehouseName: "COMPUTE_WH",

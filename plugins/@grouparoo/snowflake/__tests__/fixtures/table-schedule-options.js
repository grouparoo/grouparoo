  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 6,
        returned: 6,
        queryId: "01974207-0419-a8fc-0029-f78300011062",
  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 10,
        returned: 10,
        queryId: "01974207-0490-edaf-0029-f78300010076",
        databaseProvider: null,
        finalDatabaseName: "SAMPLE_SOURCES",
        finalSchemaName: "PUBLIC",
        finalWarehouseName: "COMPUTE_WH",

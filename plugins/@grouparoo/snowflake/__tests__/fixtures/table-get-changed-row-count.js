  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 1,
        returned: 1,
        queryId: "019b001a-0572-38b7-0029-f7830014f042",
  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 1,
        returned: 1,
        queryId: "019b001a-0563-db5d-0029-f7830015004a",
        databaseProvider: null,
        finalDatabaseName: "SAMPLE_SOURCES",
        finalSchemaName: "PUBLIC",
        finalWarehouseName: "COMPUTE_WH",

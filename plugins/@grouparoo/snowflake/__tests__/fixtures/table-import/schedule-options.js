  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 6,
        returned: 6,
        queryId: "01a11fcd-0601-82ce-0029-f783001de39e",
  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 10,
        returned: 10,
        queryId: "01a11fcd-0601-8417-0029-f783001dd746",
        databaseProvider: null,
        finalDatabaseName: "SAMPLE_SOURCES",
        finalSchemaName: "PUBLIC",
        finalWarehouseName: "COMPUTE_WH",

  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 6,
        returned: 6,
        queryId: "01a02414-0601-4f8a-0029-f783001c3bde",
  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 10,
        returned: 10,
        queryId: "01a02414-0601-4f7d-0029-f783001c2b6e",
        databaseProvider: null,
        finalDatabaseName: "SAMPLE_SOURCES",
        finalSchemaName: "PUBLIC",
        finalWarehouseName: "COMPUTE_WH",

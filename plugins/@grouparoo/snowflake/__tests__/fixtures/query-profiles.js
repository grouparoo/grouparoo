  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 10,
        returned: 10,
        queryId: "019c3479-0400-9864-0029-f78300161006",
  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 0,
        returned: 0,
        queryId: "019c3479-0400-9881-0029-f78300162006",
        databaseProvider: null,
        finalDatabaseName: "SAMPLE_SOURCES",
        finalSchemaName: "PUBLIC",
        finalWarehouseName: "COMPUTE_WH",
  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 4,
        returned: 4,
        queryId: "019c3479-0400-9881-0029-f7830016200a",
        databaseProvider: null,
        finalDatabaseName: "SAMPLE_SOURCES",
        finalSchemaName: "PUBLIC",
        finalWarehouseName: "COMPUTE_WH",
  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 4,
        returned: 4,
        queryId: "019c3479-0400-9881-0029-f7830016200e",
        databaseProvider: null,
        finalDatabaseName: "SAMPLE_SOURCES",
        finalSchemaName: "PUBLIC",
        finalWarehouseName: "COMPUTE_WH",
  ...
  .reply(
    200,
    {
      data: {
        ...
        total: 2,
        returned: 2,
        queryId: "019c3479-0400-9881-0029-f78300162012",
        databaseProvider: null,
        finalDatabaseName: "SAMPLE_SOURCES",
        finalSchemaName: "PUBLIC",
        finalWarehouseName: "COMPUTE_WH",

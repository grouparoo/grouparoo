...
nock("https://api.airtable.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "Date",
      "Sat, 08 Jan 2022 00:10:27 GMT",
      "Server",
      "Tengine",
      "Set-Cookie",
      "brw=brwAJoi0GLXQsNg6t; path=/; expires=Sun, 08 Jan 2023 00:10:27 GMT; domain=.airtable.com; samesite=none; secure",
...
nock("https://api.airtable.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "Tengine",
      "Set-Cookie",
      "brw=brwCvTGYlEuiO9rQ0; path=/; expires=Sun, 08 Jan 2023 00:10:27 GMT; domain=.airtable.com; samesite=none; secure",
      "Strict-Transport-Security",
      "max-age=31536000; includeSubDomains; preload",
      "Vary",
      "Accept-Encoding",
...
nock("https://api.airtable.com:443", { encodedQueryParams: true })
  ...
  .reply(404, { error: { type: "NOT_FOUND" } }, [
    ...
    "application/json; charset=utf-8",
    "Date",
    "Sat, 08 Jan 2022 00:10:28 GMT",
    "ETag",
    'W/"1e-3T2XZ8YB2JlzFYjAqmnw+s2G3pA"',
    "Server",
    "Tengine",
    "Set-Cookie",
    "brw=brwmMWRdXNXhxQYik; path=/; expires=Sun, 08 Jan 2023 00:10:27 GMT; domain=.airtable.com; samesite=none; secure",
    "Strict-Transport-Security",
    "max-age=31536000; includeSubDomains; preload",
    "Vary",
    "Accept-Encoding",
...
nock("https://api.airtable.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "Tengine",
      "Set-Cookie",
      "brw=brwlwm9r9JOxpZdKh; path=/; expires=Sun, 08 Jan 2023 00:10:28 GMT; domain=.airtable.com; samesite=none; secure",
      "Strict-Transport-Security",
      "max-age=31536000; includeSubDomains; preload",
      "Vary",
      "Accept-Encoding",
...
nock("https://api.airtable.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "Tengine",
      "Set-Cookie",
      "brw=brwozkTOCXoxL1S0e; path=/; expires=Sun, 08 Jan 2023 00:10:28 GMT; domain=.airtable.com; samesite=none; secure",
      "Strict-Transport-Security",
      "max-age=31536000; includeSubDomains; preload",
      "Vary",
      "Accept-Encoding",
...
nock("https://api.airtable.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "Tengine",
      "Set-Cookie",
      "brw=brwJcR51oRTVlZ09j; path=/; expires=Sun, 08 Jan 2023 00:10:28 GMT; domain=.airtable.com; samesite=none; secure",
      "Strict-Transport-Security",
      "max-age=31536000; includeSubDomains; preload",
      "Vary",
      "Accept-Encoding",

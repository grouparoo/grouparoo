...
nock("https://api.airtable.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "Date",
      "Wed, 29 Dec 2021 22:23:14 GMT",
      "Server",
      "Tengine",
      "Set-Cookie",
      "brw=brwAv9dxTRcfjfuhS; path=/; expires=Thu, 29 Dec 2022 22:23:14 GMT; domain=.airtable.com; samesite=none; secure",
...
nock("https://api.airtable.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "Tengine",
      "Set-Cookie",
      "brw=brwgMD7r65oREL1MU; path=/; expires=Thu, 29 Dec 2022 22:23:14 GMT; domain=.airtable.com; samesite=none; secure",
      "Strict-Transport-Security",
      "max-age=31536000; includeSubDomains; preload",
      "Vary",
      "Accept-Encoding",
...
nock("https://api.airtable.com:443", { encodedQueryParams: true })
  ...
  .reply(404, { error: { type: "NOT_FOUND" } }, [
    ...
    "Tengine",
    "Set-Cookie",
    "brw=brwXxtzuI6nM7IVsk; path=/; expires=Thu, 29 Dec 2022 22:23:14 GMT; domain=.airtable.com; samesite=none; secure",
    "Strict-Transport-Security",
    "max-age=31536000; includeSubDomains; preload",
    "Vary",
    "Accept-Encoding",
...
nock("https://api.airtable.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "Tengine",
      "Set-Cookie",
      "brw=brwsgFwptuhUiq1Xp; path=/; expires=Thu, 29 Dec 2022 22:23:15 GMT; domain=.airtable.com; samesite=none; secure",
      "Strict-Transport-Security",
      "max-age=31536000; includeSubDomains; preload",
      "Vary",
      "Accept-Encoding",
...
nock("https://api.airtable.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "Tengine",
      "Set-Cookie",
      "brw=brwHSIi52TFD4oXEP; path=/; expires=Thu, 29 Dec 2022 22:23:15 GMT; domain=.airtable.com; samesite=none; secure",
      "Strict-Transport-Security",
      "max-age=31536000; includeSubDomains; preload",
      "Vary",
      "Accept-Encoding",
...
nock("https://api.airtable.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "Tengine",
      "Set-Cookie",
      "brw=brwxZUTU6oCmRzN6p; path=/; expires=Thu, 29 Dec 2022 22:23:15 GMT; domain=.airtable.com; samesite=none; secure",
      "Strict-Transport-Security",
      "max-age=31536000; includeSubDomains; preload",
      "Vary",
      "Accept-Encoding",

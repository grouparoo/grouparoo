...
nock("https://api.airtable.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "Date",
      "Thu, 30 Dec 2021 01:57:07 GMT",
      "Server",
      "Tengine",
      "Set-Cookie",
      "brw=brw0rOMN9siapOIXJ; path=/; expires=Fri, 30 Dec 2022 01:57:07 GMT; domain=.airtable.com; samesite=none; secure",
...
nock("https://api.airtable.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "application/json; charset=utf-8",
      "Date",
      "Thu, 30 Dec 2021 01:57:08 GMT",
      "Server",
      "Tengine",
      "Set-Cookie",
      "brw=brwio47hI998tLtTX; path=/; expires=Fri, 30 Dec 2022 01:57:07 GMT; domain=.airtable.com; samesite=none; secure",
      "Strict-Transport-Security",
      "max-age=31536000; includeSubDomains; preload",
      "Vary",
      "Accept-Encoding",
...
nock("https://api.airtable.com:443", { encodedQueryParams: true })
  ...
  .reply(404, { error: { type: "NOT_FOUND" } }, [
    ...
    "Tengine",
    "Set-Cookie",
    "brw=brwSWvEWzxjsNrAPM; path=/; expires=Fri, 30 Dec 2022 01:57:08 GMT; domain=.airtable.com; samesite=none; secure",
    "Strict-Transport-Security",
    "max-age=31536000; includeSubDomains; preload",
    "Vary",
    "Accept-Encoding",
...
nock("https://api.airtable.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "Tengine",
      "Set-Cookie",
      "brw=brw8BCVEtlDaxyrbs; path=/; expires=Fri, 30 Dec 2022 01:57:08 GMT; domain=.airtable.com; samesite=none; secure",
      "Strict-Transport-Security",
      "max-age=31536000; includeSubDomains; preload",
      "Vary",
      "Accept-Encoding",
...
nock("https://api.airtable.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "application/json; charset=utf-8",
      "Date",
      "Thu, 30 Dec 2021 01:57:09 GMT",
      "Server",
      "Tengine",
      "Set-Cookie",
      "brw=brwaMtZToJFO9zmIX; path=/; expires=Fri, 30 Dec 2022 01:57:08 GMT; domain=.airtable.com; samesite=none; secure",
      "Strict-Transport-Security",
      "max-age=31536000; includeSubDomains; preload",
      "Vary",
      "Accept-Encoding",
...
nock("https://api.airtable.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "Tengine",
      "Set-Cookie",
      "brw=brwLCSlz44txzsdln; path=/; expires=Fri, 30 Dec 2022 01:57:09 GMT; domain=.airtable.com; samesite=none; secure",
      "Strict-Transport-Security",
      "max-age=31536000; includeSubDomains; preload",
      "Vary",
      "Accept-Encoding",

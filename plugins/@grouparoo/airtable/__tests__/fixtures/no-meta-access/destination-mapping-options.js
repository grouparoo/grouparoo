...
nock("https://api.airtable.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "Date",
      "Wed, 29 Dec 2021 22:01:30 GMT",
      "Server",
      "Tengine",
      "Set-Cookie",
      "brw=brw2iC7zomRvCEBTo; path=/; expires=Thu, 29 Dec 2022 22:01:30 GMT; domain=.airtable.com; samesite=none; secure",
...
nock("https://api.airtable.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "Tengine",
      "Set-Cookie",
      "brw=brwuWC291whz7TQaa; path=/; expires=Thu, 29 Dec 2022 22:01:30 GMT; domain=.airtable.com; samesite=none; secure",
      "Strict-Transport-Security",
      "max-age=31536000; includeSubDomains; preload",
      "Vary",
      "Accept-Encoding",
...
nock("https://api.airtable.com:443", { encodedQueryParams: true })
  ...
  .reply(404, { error: { type: "NOT_FOUND" } }, [
    ...
    "application/json; charset=utf-8",
    "Date",
    "Wed, 29 Dec 2021 22:01:31 GMT",
    "ETag",
    'W/"1e-3T2XZ8YB2JlzFYjAqmnw+s2G3pA"',
    "Server",
    "Tengine",
    "Set-Cookie",
    "brw=brwjWTkBXviflIIGo; path=/; expires=Thu, 29 Dec 2022 22:01:31 GMT; domain=.airtable.com; samesite=none; secure",
    "Strict-Transport-Security",
    "max-age=31536000; includeSubDomains; preload",
    "Vary",
    "Accept-Encoding",
...
nock("https://api.airtable.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "Tengine",
      "Set-Cookie",
      "brw=brw59PVQ2NHkmoVlR; path=/; expires=Thu, 29 Dec 2022 22:01:31 GMT; domain=.airtable.com; samesite=none; secure",
      "Strict-Transport-Security",
      "max-age=31536000; includeSubDomains; preload",
      "Vary",
      "Accept-Encoding",
...
nock("https://api.airtable.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "Tengine",
      "Set-Cookie",
      "brw=brwV1N2DmUxjJlrpe; path=/; expires=Thu, 29 Dec 2022 22:01:31 GMT; domain=.airtable.com; samesite=none; secure",
      "Strict-Transport-Security",
      "max-age=31536000; includeSubDomains; preload",
      "Vary",
      "Accept-Encoding",
...
nock("https://api.airtable.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "application/json; charset=utf-8",
      "Date",
      "Wed, 29 Dec 2021 22:01:32 GMT",
      "ETag",
      'W/"74-lTufgLG4igfzHVtzDN4LfSHZmIA"',
      "Server",
      "Tengine",
      "Set-Cookie",
      "brw=brw0tn7P5dODjFe8K; path=/; expires=Thu, 29 Dec 2022 22:01:31 GMT; domain=.airtable.com; samesite=none; secure",
      "Strict-Transport-Security",
      "max-age=31536000; includeSubDomains; preload",
      "Vary",
      "Accept-Encoding",

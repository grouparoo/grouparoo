...
nock("https://api.airtable.com:443", { encodedQueryParams: true })
  ...
  .reply(404, { error: { type: "NOT_FOUND" } }, [
    ...
    "Tengine",
    "Set-Cookie",
    "brw=brwkq9wAhkYqKOhTM; path=/; expires=Wed, 28 Dec 2022 21:06:57 GMT; domain=.airtable.com; samesite=none; secure",
...
nock("https://api.airtable.com:443", { encodedQueryParams: true })
  ...
  .reply(404, { error: { type: "NOT_FOUND" } }, [
    ...
    "Tengine",
    "Set-Cookie",
    "brw=brwQCbwBRRITlu9cS; path=/; expires=Wed, 28 Dec 2022 21:06:57 GMT; domain=.airtable.com; samesite=none; secure",
    "Strict-Transport-Security",
    "max-age=31536000; includeSubDomains; preload",
    "Vary",
    "Accept-Encoding",
...
nock("https://api.airtable.com:443", { encodedQueryParams: true })
  ...
  .reply(404, { error: { type: "NOT_FOUND" } }, [
    ...
    "Tengine",
    "Set-Cookie",
    "brw=brwmS52LS9mdUdk23; path=/; expires=Wed, 28 Dec 2022 21:06:58 GMT; domain=.airtable.com; samesite=none; secure",
    "Strict-Transport-Security",
    "max-age=31536000; includeSubDomains; preload",
    "Vary",
    "Accept-Encoding",
...
nock("https://api.airtable.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "Tengine",
      "Set-Cookie",
      "brw=brwFrkRRBRIbliAMp; path=/; expires=Wed, 28 Dec 2022 21:06:58 GMT; domain=.airtable.com; samesite=none; secure",
      "Strict-Transport-Security",
      "max-age=31536000; includeSubDomains; preload",
      "Vary",
      "Accept-Encoding",
...
nock("https://api.airtable.com:443", { encodedQueryParams: true })
  ...
  .reply(404, { error: { type: "NOT_FOUND" } }, [
    ...
    "Tengine",
    "Set-Cookie",
    "brw=brwCcOJ4HXJPudqy4; path=/; expires=Wed, 28 Dec 2022 21:06:58 GMT; domain=.airtable.com; samesite=none; secure",
    "Strict-Transport-Security",
    "max-age=31536000; includeSubDomains; preload",
    "Vary",
    "Accept-Encoding",
...
nock("https://api.airtable.com:443", { encodedQueryParams: true })
  ...
  .reply(404, { error: { type: "NOT_FOUND" } }, [
    ...
    "Tengine",
    "Set-Cookie",
    "brw=brwX0qtkT5OZAyKja; path=/; expires=Wed, 28 Dec 2022 21:06:59 GMT; domain=.airtable.com; samesite=none; secure",
    "Strict-Transport-Security",
    "max-age=31536000; includeSubDomains; preload",
    "Vary",
    "Accept-Encoding",
...
nock("https://api.airtable.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "Tengine",
      "Set-Cookie",
      "brw=brwZxTNwpiKzSMYNG; path=/; expires=Wed, 28 Dec 2022 21:06:59 GMT; domain=.airtable.com; samesite=none; secure",
      "Strict-Transport-Security",
      "max-age=31536000; includeSubDomains; preload",
      "Vary",
      "Accept-Encoding",

...
nock("https://api.sendgrid.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "close",
      "x-amzn-requestid",
      "6b0de486-1490-4cd8-b78b-90f35ee005d0",
      "x-amz-apigw-id",
      "amz3sE2KoAMFXyw=",
      "x-amzn-trace-id",
      "Root=1-6025ccfd-396db5ed33bf834b03c958b2;Sampled=0",
...
nock("https://api.sendgrid.com:443", { encodedQueryParams: true })
  ...
  .reply(
    ...
    [
      ...
      "close",
      "x-amzn-requestid",
      "f90ca98b-6ee1-40ed-bee5-8af385c9d8e9",
      "x-amz-apigw-id",
      "amz3zEHjoAMFzIg=",
      "x-amzn-trace-id",
      "Root=1-6025ccfe-6e20c6dc5f28db271c2afd99;Sampled=0",
      "x-envoy-upstream-service-time",
      "66",
      "referrer-policy",
      "strict-origin-when-cross-origin",

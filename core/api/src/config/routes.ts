  ...
  routes: (api) => {
    ...
    return {
      get: [
        ...
        { path: "/:apiVersion/apiKeys", action: "apiKeys:list" },
        { path: "/:apiVersion/apiKey/:guid", action: "apiKey:view" },
        ...
        { path: "/:apiVersion/events", action: "events:list" },
        ...
        { path: "/:apiVersion/event/:guid", action: "event:view" },
      ...
      post: [
        ...
        { path: "/:apiVersion/apiKey", action: "apiKey:create" },
        ...
        { path: "/:apiVersion/event", action: "event:create" },
        { path: "/:apiVersion/track", action: "event:create" },
      ...
      put: [
        ...
        { path: "/:apiVersion/apiKey/:guid", action: "apiKey:edit" },
      ...
      delete: [
        ...
        { path: "/:apiVersion/apiKey/:guid", action: "apiKey:destroy" },
        ...
        { path: "/:apiVersion/event/:guid", action: "event:destroy" },
